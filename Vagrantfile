...
if File.exist?('vagrant.yml')
  vconfig = YAML::load_file("#{__dir__}/vagrant.yml")
end
...
hostname        = vconfig.fetch('web', {})['hostname'] ? vconfig['web']['hostname'] : "demo.app"
...
server_ip             = vconfig.fetch('web', {})['ip'] ? vconfig['web']['ip'] : "192.168.100.100"
server_cpus           = "1"   # Cores
...
Vagrant.configure("2") do |config|
  ...
  ##########
  config.vm.provision "shell", path: "./vagrant.sh", args: [mysql_root_password]
